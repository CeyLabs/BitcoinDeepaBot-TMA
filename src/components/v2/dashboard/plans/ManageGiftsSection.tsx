...
import { GiftFilterTabs, type GiftFilter } from "@/components/v2/dashboard/plans/GiftFilterTabs";
import { GiftListCard } from "@/components/v2/dashboard/plans/GiftListCard";
